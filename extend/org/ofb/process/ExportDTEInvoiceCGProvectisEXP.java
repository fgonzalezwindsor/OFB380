 ...
 */
public class ExportDTEInvoiceCGProvectisEXP extends SvrProcess
{
	/** Properties						*/
	...
	public String CreateXMLCG(MInvoice invoice)
    {
        ...
        try
        {
          ...
          //ininoles nuevo campo vendedor provectis           
            ...
            String moneda = invoice.getC_Currency().getDescription();
          ...
          //nuevos campos para exportacion
	        ...
	        BigDecimal amtTC = (BigDecimal)invoice.get_Value("MultiplyRate");
	        if(amtTC == null)
	        	amtTC = Env.ONE;
	        ...
	        org.w3c.dom.Text mntTotOtrMndaTxt = document.createTextNode(invoice.getGrandTotal() != null ? invoice.getGrandTotal().multiply(amtTC).setScale(0,RoundingMode.HALF_EVEN).toString() : "0");
    		...
    		try
    		{
    			...
    			while (rs.next())
    			{
                    ...
                    */
                    ...
                    String paD = " ";
                    paD = rs.getBigDecimal("PRICELIST").multiply(amtTC).setScale(0,RoundingMode.HALF_EVEN).toString();                    
                    ...
                    org.w3c.dom.Text tl = document.createTextNode(rs.getBigDecimal("LINENETAMT").multiply(amtTC).setScale(0,RoundingMode.HALF_EVEN).toString());
