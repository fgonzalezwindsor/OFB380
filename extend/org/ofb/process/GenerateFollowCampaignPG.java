 ...
 */
public class GenerateFollowCampaignPG extends SvrProcess
{
		...
		try
		{
			...
			{	
				...
				String InsertD=new String("INSERT INTO C_CampaignFollow(C_CampaignFollow_ID,ad_client_id,ad_org_id,isactive,created,createdby," +
						...
						"VALUES ("+ID_Follow+","+cam.getAD_Client_ID()+","+cam.getAD_Org_ID()+",'Y','"+cam.getCreated()+"',"+
						cam.getCreatedBy()+",'"+cam.getUpdated()+"',"+cam.getUpdatedBy()+","+p_C_Campaign_ID+","+
			...
			if (p_InterestAreaValue_ID > 0)
			{
				InsertCI = new String("INSERT INTO R_CampaignInterest (r_campaigninterest_id,ad_client_id,ad_org_id,isactive,created,createdby," +
						...
						"VALUES ("+ID_Interest+","+cam.getAD_Client_ID()+","+cam.getAD_Org_ID()+",'Y','"+cam.getCreated()+"',"+
						cam.getCreatedBy()+",'"+cam.getUpdated()+"',"+cam.getUpdatedBy()+","+p_C_Campaign_ID+","+
			...
			while (rs.next())
			{
				...
				else
				{
					...
					String detalleAreasI = "SELECT ci.R_InterestArea_ID, ci.R_InterestAreaValues_ID"+
							...
							" UNION "+
							" SELECT R_InterestArea_ID FROM R_InterestArea ci WHERE IsFilter = 'Y')";
