 ...
 */
public class ExportDTEInvoiceFOLQDC extends SvrProcess
{	
	/** Properties						*/
    ...
    {	
        ...
        try
        {
          ...
          //ininoles nuevos campos de termino de pago
            ...
            org.w3c.dom.Text gPagos = document.createTextNode(GlosaPFull);
            ...
            String dirRecepStr = bloc.getLocation(true).getAddress1()+". Fono:"+bloc.getPhone();
