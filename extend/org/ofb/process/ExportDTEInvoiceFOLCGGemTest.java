 ...
 */
public class ExportDTEInvoiceFOLCGGemTest extends SvrProcess
{	
	/** Properties						*/
    		...
    		try
    		{
    			...
    			while (rs.next())
    			{
                  ...
                  //ininoles SKUIN geminis
                    ...
                    String unmdItemStr = "";
                    if(rs.getInt("M_PRODUCT_ID") > 0)                    	
                    	unmdItemStr = produc.getC_UOM().getUOMSymbol();                    
                    else 
                    	unmdItemStr = "UN";
                    if (unmdItemStr == null)
                    	unmdItemStr = "UN";
