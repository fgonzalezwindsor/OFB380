 ...
 */
public class ModPetroAmericaAmtOrder implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModPetroAmericaAmtOrder ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModPetroAmericaAmtOrder.class);
	/** Client			*/
	...
	public String docValidate (PO po, int timing)
	{
		...
		if(timing == TIMING_BEFORE_COMPLETE && po.get_Table_ID()==MOrder.Table_ID)
		{
			...
			if(order.getC_DocType().getDocBaseType().compareToIgnoreCase("POO") == 0)
			{
				...
				if (amtToCmp.compareTo(order.getGrandTotal()) < 0)
				{
