	...
	implements ActionListener, ChangeListener
{
	...
	{
		super(frame, Msg.getMsg(Env.getCtx(), "InfoSchedule"), frame != null && true);//faaguilar OFB
		if (mAssignment == null)
		...
		m_createNew = true;//faaguilar OFB
		try
		{
			jbInit();
			dynInit(true);//faaguilar OFB
		}
		catch(Exception ex)
		{
	...
	//	timePane.add(monthSchedule,   Msg.getMsg(Env.getCtx(), "Month"));
		...
		mainPanel.setPreferredSize(new Dimension(1024, 800));//faaguilar OFB
		//
	...
	private void displayCalendar ()
	{
		...
		if(m_mAssignment!=null)//faaguilar OFB
	...
	public void mAssignmentCallback (MResourceAssignment assignment)
	{
		...
		/*if (m_createNew)
			dispose();faaguilar OFB original code commented
		else*/
			displayCalendar();
	}	//	mAssignmentCallback
