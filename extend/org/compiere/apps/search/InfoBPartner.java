...
public class InfoBPartner extends Info
{
	...
	private static Info_Column[] s_partnerLayout = {
		...
		/*new Info_Column(Msg.translate(Env.getCtx(), "Address1"), "a.Address1", String.class),*///faguilar OFB original code commented
		new Info_Column(Msg.translate(Env.getCtx(), "Address1"), "l.name as Address", String.class),//faaguilar OFB added
	...
	private void initInfo(String value, String whereClause)
	{
		...
		**/
		...
		if (value == null)
		{
			fieldValue.setText("%");//OFB faaguilar added
			fieldName.setText("%");//OFB faaguilar added
			//	value = "%"; //faaguilar OFB original code commented
	...
	protected String getSQLWhere()
	{
		...
		if (!(name.equals("") || name.equals("%")))
			if (!alias())//faaguilar OFB
				list.add ("UPPER(C_BPartner.Name) LIKE ?");
			else
				list.add ("(UPPER(C_BPartner.Name) LIKE ? or UPPER(C_BPartner.Alias) LIKE '%"+name+"%' )");//faaguilar OFB
		//	=> Contact
