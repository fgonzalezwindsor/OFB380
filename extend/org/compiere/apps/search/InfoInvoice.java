...
//	private VLookup fOrg_ID;
	...
	//
	private CLabel lDateFrom = new CLabel(Msg.translate(Env.getCtx(), "DueDate"));//faaguilar
	...
	//		sql.append(" AND UPPER(i.POReference) LIKE ?");
		...
		//
		if (fDateFrom.getValue() != null || fDateTo.getValue() != null)//faaguilar DueDate for DateInvoiced
		{
