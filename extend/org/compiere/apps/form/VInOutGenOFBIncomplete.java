 ...
 */
public class VInOutGenOFBIncomplete extends CPanel
		...
		ChangeListener, TableModelListener, ASyncProcess
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VInOutGenOFBIncomplete.class);
	//
	...
	private void generateShipments ()
	{
        ...
        AD_Process_ID = DB.getSQLValue(trx.getTrxName(), "select AD_Process_ID from AD_Process where Name='InOutGenerateOFBIncomplete'");
        if(AD_Process_ID<=0){
