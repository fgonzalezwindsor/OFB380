	...
	implements FormPanel, ActionListener, TableModelListener, VetoableChangeListener
{
	...
	public void calculate()
	{
		...
		if (p_case!=INDICATOR_NONE && p_case!=INDICATOR_CURRENCY_DIFF)
		{
		...
		if(p_case==INDICATOR_CURRENCY_DIFF){
			allocateButton.setEnabled(false);
			ADialog.warn(m_WindowNo, panel, "La moneda no coincide con los documentos");
		}
		//faaguilar OFB End
	}
