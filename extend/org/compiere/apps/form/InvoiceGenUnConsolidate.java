 ...
 * 
 */
public class InvoiceGenUnConsolidate extends GenForm
{
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(InvoiceGenUnConsolidate.class);
	//
	...
	public String generate(IStatusBar statusBar, KeyNamePair docTypeKNPair, String docActionSelected)
	{
		...
		para.setParameter("ConsolidateDocument", "N");
