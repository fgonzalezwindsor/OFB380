	...
	implements VEditor, ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		int M_Product_ID = (Integer)m_GridTab.getValue("M_Product_ID");//faaguilar OFB
		...
		log.config("M_Product_ID=" + M_Product_ID + "/" + M_ProductBOM_ID
			...
			+ ", AD_Column_ID=" + m_AD_Column_ID + ", WindowNo ="+m_WindowNo);
		...
		if (changed)
		{
			...
			try
			{
				String columnNameTo = "M_AttributeSetInstanceTo_ID";//faaguilar 
				fireVetoableChange(columnNameTo, new Object(), getValue());
			}
			catch (PropertyVetoException pve)
			{
				log.log(Level.SEVERE, "", pve);
