...
// DR
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_PaymentRequest[")
	...
	/** Set C_PaymentRequest.
		@param C_PaymentRequest_ID C_PaymentRequest	  */
	...
	/** Get C_PaymentRequest.
		@return C_PaymentRequest	  */
  ...
  */
	...
	/** RequestType AD_Reference_ID=1000042 */
	public static final int REQUESTTYPE_AD_Reference_ID=1000042;
	/** Desde Factura = I */
	public static final String REQUESTTYPE_DesdeFactura = "I";
	/** Desde Resolucion = R */
	public static final String REQUESTTYPE_DesdeResolucion = "R";
	/** Desde Contabilidad = J */
	public static final String REQUESTTYPE_DesdeContabilidad = "J";
	/** Desde Remuneracion*/
	public static final String REQUESTTYPE_DesdeRemuneracion = "P";
	/** Ingreso Manual*/
	//nuevo tipo para ingresar lineas manuales.
	public static final String REQUESTTYPE_IngresoManual = "M";
	/** Set Request Type.
	...
	public  X_C_PaymentRequestLine[] getLines ()
	{
		ArrayList< X_C_PaymentRequestLine> list = new ArrayList<X_C_PaymentRequestLine> ();
		StringBuffer sql = new StringBuffer("SELECT * FROM C_PaymentRequestLine WHERE C_PaymentRequest_ID=? ");
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try
		{
			pstmt = DB.prepareStatement(sql.toString(), get_TrxName());
			pstmt.setInt(1, getC_PaymentRequest_ID());
			rs = pstmt.executeQuery();
			while (rs.next())
			{
				X_C_PaymentRequestLine ol = new X_C_PaymentRequestLine(getCtx(), rs, get_TrxName());
				list.add(ol);
			}
 		}
		catch (Exception e)
		...
		//
		X_C_PaymentRequestLine[] lines = new  X_C_PaymentRequestLine[list.size ()];
		list.toArray (lines);
		return lines;
	}
}