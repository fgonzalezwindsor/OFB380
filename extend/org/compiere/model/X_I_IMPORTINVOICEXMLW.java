...
/** Generated Model for I_IMPORTINVOICEXMLW
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_I_IMPORTINVOICEXMLW extends PO implements I_I_IMPORTINVOICEXMLW, I_Persistent 
{
    ...
    public X_I_IMPORTINVOICEXMLW (Properties ctx, int I_IMPORTINVOICEXMLW_ID, String trxName)
    {
      super (ctx, I_IMPORTINVOICEXMLW_ID, trxName);
      /** if (I_IMPORTINVOICEXMLW_ID == 0)
        {
			setI_IMPORTINVOICEXMLW_ID (0);
        } */
    }

    /** Load Constructor */
    public X_I_IMPORTINVOICEXMLW (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_IMPORTINVOICEXMLW[")
	...
	{
		set_Value (COLUMNNAME_CODIGO_CLIENTE, CODIGO_CLIENTE);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_CODIGO_CLIENTE);
	}
	...
	/** Set I_IMPORTINVOICEXMLW.
		@param I_IMPORTINVOICEXMLW_ID I_IMPORTINVOICEXMLW	  */
	public void setI_IMPORTINVOICEXMLW_ID (int I_IMPORTINVOICEXMLW_ID)
	{
		if (I_IMPORTINVOICEXMLW_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_IMPORTINVOICEXMLW_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_IMPORTINVOICEXMLW_ID, Integer.valueOf(I_IMPORTINVOICEXMLW_ID));
	}

	/** Get I_IMPORTINVOICEXMLW.
		@return I_IMPORTINVOICEXMLW	  */
	public int getI_IMPORTINVOICEXMLW_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_IMPORTINVOICEXMLW_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set TERMINO_PAGO.
		@param TERMINO_PAGO TERMINO_PAGO	  */
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_TERMINO_PAGO);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		return (String)get_Value(COLUMNNAME_TERMINOPAGO);
	}

	/** Set TOTAL_IVA_CHILE.
		@param TOTAL_IVA_CHILE TOTAL_IVA_CHILE	  */
	public void setTOTAL_IVA_CHILE (BigDecimal TOTAL_IVA_CHILE)
	{
		set_Value (COLUMNNAME_TOTAL_IVA_CHILE, TOTAL_IVA_CHILE);
	}

	/** Get TOTAL_IVA_CHILE.
		@return TOTAL_IVA_CHILE	  */
	public BigDecimal getTOTAL_IVA_CHILE () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_TOTAL_IVA_CHILE);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
