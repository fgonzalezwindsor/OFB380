...
//			+ " AND TRUNC(c.StatementDate)=?"			//	#2 comment by faaguilar
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if(getDocStatus().equals("DR"))
		{
			...
			if(count>0)
			{
				log.saveError("Error", "Ya existe otra caja en borrador o en proceso por favor compl�tela antes de crear una nueva");
								m_processMsg = "Ya existe otra caja en borrador por favor compl�tela antes de crear una nueva";
								return false;
			}
		}
		//End validation
