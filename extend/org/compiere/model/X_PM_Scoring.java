...
/** Generated Model for PM_Scoring
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_PM_Scoring extends PO implements I_PM_Scoring, I_Persistent 
{
    ...
    public X_PM_Scoring (Properties ctx, int PM_Scoring_ID, String trxName)
    {
      super (ctx, PM_Scoring_ID, trxName);
      /** if (PM_Scoring_ID == 0)
        {
			setDocStatus (null);
// DR
    ...
    /** Load Constructor */
    public X_PM_Scoring (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PM_Scoring[")
	...
	{
		if (PM_Scoring_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_PM_Scoring_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_PM_Scoring_ID, Integer.valueOf(PM_Scoring_ID));
	}
