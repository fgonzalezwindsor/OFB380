...
public class MProject extends X_C_Project
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		//faaguilar OFB gore, validacion antes guardar
		if(get_ValueAsInt("PM_Tender_ID")>0 && newRecord){
			X_PM_Tender tender = new X_PM_Tender(getCtx(), get_ValueAsInt("PM_Tender_ID"), get_TrxName());
			if(tender.getDocStatus().equals("CL"))
			{
				log.saveError("Error","No puede seleccionar un concurso o grupo cerrado :" + tender.getName());
				return false;
			}
