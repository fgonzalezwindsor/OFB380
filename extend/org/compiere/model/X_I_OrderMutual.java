...
/** Generated Model for I_OrderMutual
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_I_OrderMutual extends PO implements I_I_OrderMutual, I_Persistent 
{
    ...
    public X_I_OrderMutual (Properties ctx, int I_OrderMutual_ID, String trxName)
    {
      super (ctx, I_OrderMutual_ID, trxName);
      /** if (I_OrderMutual_ID == 0)
        {
			setI_IsImported (false);
			setI_OrderMutual_ID (0);
        } */
    }

    /** Load Constructor */
    public X_I_OrderMutual (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_OrderMutual[")
	...
	/** Set I_OrderMutual.
		@param I_OrderMutual_ID I_OrderMutual	  */
	public void setI_OrderMutual_ID (int I_OrderMutual_ID)
	{
		if (I_OrderMutual_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_OrderMutual_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_OrderMutual_ID, Integer.valueOf(I_OrderMutual_ID));
	}

	/** Get I_OrderMutual.
		@return I_OrderMutual	  */
	public int getI_OrderMutual_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_OrderMutual_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
