...
public class MPOS extends X_C_POS
{
	...
	public String getDisplayName(){
		...
		customName=getName() +"/" + (MUser.getNameOfUser(getSalesRep_ID()))+"/"+getC_POS_ID();
		
		return customName;
	}
	
	public  MPOS getPosbyDisplay(String displayName){
		int POS_ID;
		
		String[] valuesList=displayName.split("/");
		POS_ID= Integer.parseInt(valuesList[valuesList.length-1]);
		
		return new MPOS (getCtx(), POS_ID, null);
	}
}	//	MPOS
