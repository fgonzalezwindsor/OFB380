...
public class MLocation extends X_C_Location implements Comparator
{
	...
	private 	MCity		m_ct = null;//faaguilar OFB
	...
	//faaguilar OFB custom method getMCity()
	/**
	 * 	Get City
	 *	@return City
	 */
	...
	{
		if (m_ct == null && getC_City_ID() != 0)
			m_ct = MCity.get(getCtx(), getC_City_ID());
		return m_ct;
	}	//	
	
	//faaguilar OFB custom method setCity
	/**
	 * 	Set City
	 *	@param City
	 */
	public void setMCity (MCity city)
	{
		m_ct = city;
		if (city == null)
		...
		{
			super.setC_City_ID(m_ct.getC_City_ID());
		}
	}	//	setRegion
}	//	MLocation
