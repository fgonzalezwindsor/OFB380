...
public class MProduct extends X_M_Product
{
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
		...
		//	New Costing
		/*original code commented faaguilar OFB
	...
	//faaguilar OFB custom metod
	public int getLocator( int WareHouse_ID)
	{
		int maxqty=DB.getSQLValue(null,"select nvl(max(b.qtyonhand),0) from m_storage b where b.m_product_id="+ getM_Product_ID() 
		+" and b.m_warehouse_id="+WareHouse_ID);
		
		if(maxqty==0)
		return 0;
		else
		{
			int locator_id=DB.getSQLValue(null,"select m_locator_id from m_storage "
			+" where QTYONHAND="+maxqty
			+" and m_warehouse_id="+WareHouse_ID +"and m_product_id="+getM_Product_ID()+ "and rowid=1");
