...
/** Generated Model for M_RequisitionCalendar
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_M_RequisitionCalendar extends PO implements I_M_RequisitionCalendar, I_Persistent 
{
    ...
    public X_M_RequisitionCalendar (Properties ctx, int M_RequisitionCalendar_ID, String trxName)
    {
      super (ctx, M_RequisitionCalendar_ID, trxName);
      /** if (M_RequisitionCalendar_ID == 0)
        {
			setC_BPartner_ID (0);
    ...
    /** Load Constructor */
    public X_M_RequisitionCalendar (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_RequisitionCalendar[")
	...
	public void setM_RequisitionCalendar_ID (int M_RequisitionCalendar_ID)
	{
		if (M_RequisitionCalendar_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_M_RequisitionCalendar_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_M_RequisitionCalendar_ID, Integer.valueOf(M_RequisitionCalendar_ID));
	}
