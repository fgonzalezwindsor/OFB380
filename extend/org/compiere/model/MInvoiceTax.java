...
public class MInvoiceTax extends X_C_InvoiceTax
{
	...
	public boolean calculateTaxFromLines ()
	{
		...
		BigDecimal auxAmt=Env.ZERO;//faaguilar OFB
		//
		...
		setTaxAmt(taxAmt.setScale(0, BigDecimal.ROUND_HALF_UP));//faaguilar OFB scale

		if(auxAmt.signum()>0)//faaguilar OFB
			setTaxAmt(auxAmt.setScale(0, BigDecimal.ROUND_HALF_UP));//faaguilar OFB
