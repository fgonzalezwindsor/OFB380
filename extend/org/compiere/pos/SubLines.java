...
public class SubLines extends PosSubPanel implements ActionListener
{
	...
	private static ColumnInfo[] s_layout = new ColumnInfo[] 
	{
		...
		//faaguilar OFB begin
		new ColumnInfo(Msg.translate(Env.getCtx(), "PriceBruto"), "round(PriceActual*1.19)", BigDecimal.class),
		new ColumnInfo(Msg.translate(Env.getCtx(), "LineTotalAmt"), "round(LineNetAmt*1.19)", BigDecimal.class), 
		//faaguilar OFB end
