...
public class CreateCombinations extends SvrProcess
{
	...
	protected String doIt() throws Exception
	{
		...
		DB.executeUpdate("update C_VALIDCOMBINATION a "+
		"set a.ad_org_id=0, "+
 		"a.alias=(select b.value from C_ELEMENTVALUE b where b.C_ELEMENTVALUE_ID=a.ACCOUNT_ID), "+
		"a.description=(select b.name from C_ELEMENTVALUE b where b.C_ELEMENTVALUE_ID=a.ACCOUNT_ID)",get_TrxName());
