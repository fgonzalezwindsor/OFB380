	...
	protected String doIt() throws Exception
	{
		...
		try
		{
			...
			//	payment.setC_ConversionType_ID(imp.getC_ConversionType_ID());
				...
				//ininoles importar campo descripcion y numero de egreso/ingreso inicio
				payment.set_CustomColumn("Description", imp.get_Value("Description"));
				payment.set_CustomColumn("Correlative", imp.get_Value("Correlative"));
				//ininoles 
