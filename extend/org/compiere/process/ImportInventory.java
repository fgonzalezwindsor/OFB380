	...
	protected String doIt() throws java.lang.Exception
	{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				//begin faaguilar atributes  M_AttributeSet_ID=1000000
				if(imp.get_ColumnIndex("Tratamiento")>=0)//verificacion de columnas nuevas
				{
					...
					//M_Attribute_ID=1000009 Ancho
					if(imp.get_ValueAsInt("Ancho")>0)
					{
						MAttributeInstance at1 = new MAttributeInstance(getCtx(), 1000009, 
								att.getM_AttributeSetInstance_ID(),imp.get_ValueAsInt("Ancho"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Ancho")), get_TrxName());
						at1.save();
					}
					// M_Attribute_ID=1000000 certificacion
					if(imp.get_ValueAsInt("Certificacion")>0)
					{
						MAttributeInstance at2 = new MAttributeInstance(getCtx(), 1000000, 
								att.getM_AttributeSetInstance_ID(),imp.get_ValueAsInt("Certificacion"), 
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Certificacion")), get_TrxName()); 
						at2.save();
					}
					//M_Attribute_ID=1000007 descripcion estado
					if(imp.get_ValueAsInt("DescEstado")>0)
					{
						MAttributeInstance at3 = new MAttributeInstance(getCtx(), 1000007, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("DescEstado"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("DescEstado")), get_TrxName()); 
						at3.save();
					}
					//M_Attribute_ID=1000002 estado
					if(imp.get_ValueAsInt("Estado")>0)
					{
						MAttributeInstance at4 = new MAttributeInstance(getCtx(), 1000002, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("Estado"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Estado")), get_TrxName()); 
						at4.save();
					}
					//M_Attribute_ID=1000006 humedad
					if(imp.get_ValueAsInt("Humedad")>0)
					{
						MAttributeInstance at5 = new MAttributeInstance(getCtx(), 1000006, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("Humedad"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Humedad")), get_TrxName());
						at5.save();
					}
					// M_Attribute_ID=1000001 largo
					if(imp.get_ValueAsInt("Largo")>0)
					{
						MAttributeInstance at6 = new MAttributeInstance(getCtx(), 1000001, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("Largo"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Largo")), get_TrxName()); 
						at6.save();
					}
					// M_Attribute_ID=1000005 proveedor
					if(imp.get_ValueAsInt("Proveedor")>0)
					{
						MAttributeInstance at7 = new MAttributeInstance(getCtx(), 1000005, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("Proveedor"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Proveedor")), get_TrxName());
						at7.save();
					}
					//M_Attribute_ID=1000004 terminacion
					if(imp.get_ValueAsInt("Terminacion")>0)
					{
						MAttributeInstance at8 = new MAttributeInstance(getCtx(), 1000004, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("Terminacion"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Terminacion")), get_TrxName());
						at8.save();
					}
					// M_Attribute_ID=1000008 terminacion al largo
					if(imp.get_ValueAsInt("TerminacionLargo")>0)
					{
						MAttributeInstance at9 = new MAttributeInstance(getCtx(), 1000008, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("TerminacionLargo"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("TerminacionLargo")), get_TrxName()); 
						at9.save();
					}
					//M_Attribute_ID=1000003 tratamiento
					if(imp.get_ValueAsInt("Tratamiento")>0)
					{
						MAttributeInstance at10 = new MAttributeInstance(getCtx(), 1000003, 
								att.getM_AttributeSetInstance_ID(), imp.get_ValueAsInt("Tratamiento"),
								DB.getSQLValueString(get_TrxName(), "select name from m_attributevalue where m_attributevalue_id =?", imp.get_ValueAsInt("Tratamiento")), get_TrxName()); 
						at10.save();
					}
