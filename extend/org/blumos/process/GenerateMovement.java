		...
		try
		{
			...
			while (rs.next ())
			{
				...
				if(id_invAD != LastMov)
				{
					...
					*/
					...
					else
					{
						...
						return "ERROR 102: El socio de negocio no tiene dirección asociada";
					}
				...
				else
				{
					...
					return "ERROR 301: Producto con código "+rs.getString("codigo_produto")+" no se conoce. Nro doc "+rs.getString("numero_nf");
				}
			...
			//@mfrojas completar último documento
