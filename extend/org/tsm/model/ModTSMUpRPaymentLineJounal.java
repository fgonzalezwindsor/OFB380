 ...
 */
public class ModTSMUpRPaymentLineJounal implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModTSMUpRPaymentLineJounal ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModTSMUpRPaymentLineJounal.class);
	/** Client			*/
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		{	
			...
			if(rLine.getGL_JournalLine_ID() > 0)
				rLine.set_CustomColumn("GL_Journal_ID", rLine.getGL_JournalLine().getGL_Journal_ID());			
		}		
		return null;
	}	//	modelChange
