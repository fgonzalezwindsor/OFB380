 ...
 */
public class ModBaskakowValidSO_Credit implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModBaskakowValidSO_Credit ()
	{
		super ();
	}	//	MyValidator
	...
	{	
		...
		//model que valida credito en despacho
		...
		{	
			...
			{
				return "Error Credito Insuficiente - Saldo Actual="+(BigDecimal)bp.get_Value("TotalOpenBalanceOFB")+";" +
				" Monto documento="+invAmt;			
			}
		}
		return null;
	}	//	docValidate
