 ...
 */
public class SendMailMetlifePro extends SvrProcess
{	
	/** Properties						*/
	...
	protected String doIt () throws Exception
	{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				String comodin = "\\";
				String pathTemp = comodin+comodin+"mlfsoaprd01"+comodin+"templates"+comodin+"MFSMutuariaBienvenida"+comodin+"Muturia.jpg";				
				//end seteo
    ...
    private String llamarMFSMutuariaBienvenida(String CustomerRUT,String CustomerMail,String Template,
    		...
    		String Montodecredito, String Cargoejecutivo, String Fonofijo, String celular, String CorreoEje) throws Exception
    {	    	
    	String msgRet = "";
    	final String request = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ws=\"http://ws.documentservice.metlife.cl/\">"+
		   ...
		   "</soapenv:Envelope>";
   			...
   			try
   			{
   				...
   				wsc.setEndpointAddress("http://mlfsoaprd01:9080/documentService/DocumentSenderService");
