 ...
 */
public class ImportOrderMutual extends SvrProcess
{
		...
		**/
		...
		try
		{
			...
			while (rs.next ())
			{
				...
				//ininoles nuevos campos en las lineas para CPV
				BigDecimal UFAmt = (BigDecimal)imp.get_Value("UFAmt");				
				line.set_CustomColumn("UFAmt", UFAmt);
				line.set_CustomColumn("EO_Agreement_ID", imp.get_ValueAsInt("EO_Agreement_ID"));
				//				
				line.save();
