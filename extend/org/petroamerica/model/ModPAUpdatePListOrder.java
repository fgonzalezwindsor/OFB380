 ...
 */
public class ModPAUpdatePListOrder implements ModelValidator
{
	/**
	 *	Constructor.
	 *	The class is instantiated when logging in and client is selected/known
	 */
	public ModPAUpdatePListOrder ()
	{
		super ();
	}	//	MyValidator

	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(ModPAUpdatePListOrder.class);
	/** Client			*/
	...
	public String modelChange (PO po, int type) throws Exception
	{
		...
		if(type == TYPE_BEFORE_NEW && po.get_Table_ID()==MOrder.Table_ID) 
		{	
